            ...
            steps {
                withCredentials([usernamePassword(credentialsId: 'myaws', passwordVariable: 'AWS_SECRET_ACCESS_KEY', usernameVariable: 'AWS_ACCESS_KEY_ID')]) {
                    ...
                    sh '''
                        ...
                        aws ecs update-service --cluster LearnjenkinsApp-Cluster-Prod --service LearnJenkinsApp-Service-Prod:2 --task-definition LearnJenkinsApp-TaskDefinition-Prod
                    '''
                }
            }                     
        }
